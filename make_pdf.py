...
Usage:
  python3 make_pdf.py                       # all cards/ -> flashcards.pdf
  python3 make_pdf.py --src cards_d3 --out d3.pdf
  python3 make_pdf.py --width 900           # downscale pages to keep size small
"""
...
def main():
    ...
    ap.add_argument("--src", default="cards")
    ap.add_argument("--out", default="flashcards.pdf")
